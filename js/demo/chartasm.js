...
var myLineChart = new Chart(ctxCH, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: [47, 66, 102, 131, 164, 202, 250, 278, 318],
    }],
  },
  options: {
...
var myLineChart = new Chart(ctxCH1, {
  ...
  data: {
    ...
    datasets: [{
      ...
      pointHoverRadius: 3,
      pointHoverBackgroundColor: "#023020",
      pointHoverBorderColor: "#023020",
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: [2313, 4094, 6112, 8827, 12390, 15744, 19264, 20205, 24829],
    }],
  },
  options: {
    maintainAspectRatio: false,
...
var myPieChart = new Chart(ctxPIE1, {
  ...
  data: {
    ...
    datasets: [{
      data: [55, 30, 15],
      backgroundColor: ['#4e73df', '#1cc88a', '#36b9cc', 'blue'],
      hoverBackgroundColor: ['#2e59d9', '#17a673', '#2c9faf','blue'],
